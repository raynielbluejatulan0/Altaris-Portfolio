  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        boxShadow: "0 12px 40px rgba(0, 0, 0, 0.3), 0 0 20px rgba(108, 92, 231, 0.1)",
    ...
    return (
      <motion.div
        ...
        whileHover={{
          y: -6,
          borderColor: "rgba(108, 92, 231, 0.3)",
          boxShadow: "0 8px 40px rgba(0, 0, 0, 0.3), 0 0 15px rgba(108, 92, 231, 0.1)",
